...
class CategoriaRepositoryTest {
    ...
    @Test
    void findByEmpresaShouldReturnOnlyCategoriasFromRequestedEmpresa() {
        ...
        List<Categoria> categorias = categoriaRepository.findByEmpresa(empresaA);

        assertThat(categorias)
                .extracting(Categoria::getId)
                .containsExactlyInAnyOrder(bebidas.getId(), limpeza.getId());
    }
